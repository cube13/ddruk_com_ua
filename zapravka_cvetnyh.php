...
<td class=\"border_bottom\" width=\"*\"><strong><span style=\"font-size: small;\">Стоимость<br>нового, грн.</span></strong></td>
</tr>";
$KEYWORDS="";$KEYWORDS_1="";
$flag_chip=0;
while(list($printer_id,$printer_name,$cart_id,$cart_name,$zapravka,$vostanov,$chip,$cart_title,$print_title,$noviy,$noviy_bn,$color)=mysql_fetch_row($cartridge->sql_res))
{
$link_to_chip="";
...
if($cart_title=="")
{$price_table.="<td >$cart_name <div id='color_$color'></div</td>";}
else
{$price_table.="<td ><a href=\"zapravka-i-vosstanovlenie-$cart_name.html\">$cart_name</a>
    <div id='color_$color'></td>";}
...
$page_title="Заправка цветных картриджей $_GET[brand]";
...
$set_title="Заправка цветных картриджей $_GET[brand]";
$set_keywords="Заправка цветных картриджей $_GET[brand]";
$set_description="Заправка цветных картриджей $_GET[brand] по приемлемой цене и с гарантией качества.";
...
<div style="float:center;min-width: 1001px; width:100%;" >
    ...
    <div class="price_zaglav"><?php echo $page_title;?></div> 
     <div style="text-align: justify;margin-left: 5px;margin-right: 35px;font-size: 12px;"><?php echo $page_content;?></div>
